...
let SettingsController = class SettingsController {
    ...
    async create(req, createSettingDto) {
        return this.settingsService.create(req.user.sub, createSettingDto);
    }
    async findAll() {
    ...
    async update(req, updateSettingDto) {
        return this.settingsService.update(req.user.sub, updateSettingDto);
    }
    async remove(req) {
        return this.settingsService.remove(req.user.sub);
    }
};
exports.SettingsController = SettingsController;
__decorate([
    (0, common_1.Post)('profile'),
    (0, audit_decorator_1.AuditLog)('CREATE_PROFILE'),
...
__decorate([
    ...
    (0, audit_decorator_1.AuditLog)('SELECT_PROFILES'),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, audit_decorator_1.AuditLog)('SELECT_PROFILE'),
...
__decorate([
    ...
    (0, audit_decorator_1.AuditLog)('UPDATE_PROFILE'),
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, audit_decorator_1.AuditLog)('REMOVE_PROFILE'),
    __param(0, (0, common_1.Req)()),
    __metadata("design:type", Function),
