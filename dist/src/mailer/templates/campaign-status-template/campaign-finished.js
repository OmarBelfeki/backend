...
exports.campaignFinished = void 0;
exports.campaignFinished = `
<!DOCTYPE html>
<html lang="fr">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>Campagne Terminée</title>
...
<div class="header">
<h1>Rapport campagne terminé</h1>
</div>

<div class="content">

<p>Votre campagne est terminée.</p>

<div class="alert-box">
<div class="info-row"><div class="label">Campagne</div><div class="value">%campaign_name%</div></div>
<div class="info-row"><div class="label">Envoyés</div><div class="value">%total_sent%</div></div>
<div class="info-row"><div class="label">Livrés</div><div class="value">%total_delivered%</div></div>
<div class="info-row"><div class="label">Échoués</div><div class="value">%total_failed%</div></div>
<div class="info-row"><div class="label">Coût final</div><div class="value">%final_cost%</div></div>
<div class="info-row"><div class="label">Rapport</div><div class="value">%report_url%</div></div>
</div>

</div>

<div class="notice">
Rapport généré automatiquement après exécution complète.
</div>
...
`;
//# sourceMappingURL=campaign-finished.js.map